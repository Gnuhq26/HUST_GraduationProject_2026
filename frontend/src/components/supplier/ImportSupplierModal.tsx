    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-blacky-950/30 flex items-center justify-center z-50 p-4">
      <div className="bg-basic-white rounded-2xl border border-basic-border max-w-3xl w-full max-h-[90vh] flex flex-col shadow-lg">
        ...
        <div className="px-6 py-4 border-b border-yellowfish-400 flex items-center justify-between shrink-0">
          <div>
            <h2 className="text-xl font-bold text-blacky-950">Import nhà cung cấp từ Excel</h2>
          ...
          {step === 'template' && (
            <div className="space-y-5">
              ...
              <div className="bg-blacky-50 border border-basic-border rounded-xl p-4">
                ...
                />
                {file && (
                  <p className="mt-2 text-sm text-accent-green flex items-center gap-1.5">
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-bluesh-800 sticky top-0">
                      <tr>
                        ...
                        <th className="px-3 py-2 text-left text-xs font-medium text-basic-white">Tên NCC</th>
                    ...
                    <tbody className="divide-y divide-basic-border">
                      {previewData.rows.map((row, idx) => (
                        ...
                        >
                          ...
                          <td className="px-3 py-2 font-medium text-blacky-950">{row.supplierName}</td>
